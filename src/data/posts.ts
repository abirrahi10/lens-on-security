...
export const posts: Post[] = [
  {
    slug: 'a-pillars-purpose',
    title: "A Pillar's Purpose",
    dek: 'Why your organizational security pillars deserve a second look.',
    date: 'July 22, 2026',
    readTime: '4 min read',
    tags: ['networking', 'identity', 'pillars'],
    images: [
      { src: '/images/a-pillars-purpose/DSCF4799.JPG', alt: 'A picture of the Met Museum focusing on the pillars against a clear sky' }
    ],
    body: [
    ...
    // Add a source only when you use one. The Sources section stays hidden when this is empty or omitted.
    sources: [
